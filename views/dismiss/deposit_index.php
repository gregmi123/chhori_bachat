...
$this->title = 'जम्मा रकम निकाल्ने कारण';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="dismiss-index">

    <p>
        <?= Html::a('सिर्जना गर्नुहोस', ['deposit-create'], ['class' => 'btn btn-success']) ?>
    </p>
    ...
    <?= GridView::widget([
        ...
        'panel' => [
            ...
            'heading' => '<b style="font-weight:bold;margin-left:40%;">जम्मा रकम निकाल्ने कारण</b>',
