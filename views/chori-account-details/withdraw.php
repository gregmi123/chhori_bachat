...
$this->title = 'जम्मा रकम निकाल्नको लागी';
...
<div class="chori-account-details-index">
    ...
    <?= GridView::widget([
        ...
        'panel' => [
            ...
            'heading' => '<b style="font-weight:bold;margin-left:40%;">जम्मा रकम निकाल्नको लागी</b>',
        ...
        'columns' => [
            ...
            'buttons' => [
                ...
                'urlCreator' => function ($action, $model, $key, $index) {
                    if ($action === 'view') {
                        $url ='index.php?r=withdraw/create&id='.$model['id'];
                        return $url;
                    }
                }
