...
$this->params['breadcrumbs'][] = ['label' => ' मासिक जम्माको लागी बैंकलाइ अनुरोध '];
...
<div class="payment-chori-form">
    ...
    <div class="col-md-12">
        ...
        <div class="col-sm-4">
        <br>
            <!-- <?= $form->field($model, 'deposit_method')->dropDownList(['1'=>'मासीक','2'=>'त्रैमासीक'], ['id' => 'method', 'prompt' => 'छान्नुहोस्','onchange'=>'hide()']); ?> -->
            <?= $form->field($model, 'deposit_method')->dropDownList(['2'=>'चौमासिक'], ['id' => 'method', 'onchange'=>'hide()']); ?>
        </div>
        ...
        <div class="col-md-4" style="" id="month-method">
            <br>
            <!-- <?= $form->field($model, 'month_method')->dropDownList(['1'=>'प्रथम','2'=>'दोस्रो','3'=>'तेस्रो','4'=>'चौथो'], ['id' => 'month_method_value', 'prompt' => 'छान्नुहोस्']); ?> -->
            <?= $form->field($model, 'month_method')->dropDownList(['1'=>'प्रथम','2'=>'दोस्रो','3'=>'तेस्रो'], ['id' => 'month_method_value', 'prompt' => 'छान्नुहोस्']); ?>
...
//        target_data.hide();
    function myfun(year) {
        ...
        //alert(month);
        // console.log(month);
        $.post('index.php?r=payment-chori/deposit&month='  + month + '&year=' + year +'&method='+method);
