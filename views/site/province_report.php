...
$bank=\yii\helpers\Arrayhelper::map(\app\models\BankDetails::find()->where(['fk_province_id'=>$user_details['fk_province_id']])->all(),'id','bank_name');
...
$year=\yii\helpers\Arrayhelper::map(\app\models\Year::find()->all(),'id','economic_year');
...
<div class="col-md-12">
    ...
    <?= $form->field($model, 'caste_search')->widget(Select2::classname(), [
                                    'data' => $caste,
                                    'language' => 'en',
                                    'options' => ['placeholder' => 'सबै','id' => 'caste','allowClear' => true,],
                                    'pluginOptions' => [
                                        'allowClear' => true
                                    ],
                                ]);
    ...
    <?= $form->field($model, 'bank_search')->widget(Select2::classname(), [
                                    'data' => $bank,
                                    'language' => 'en',
                                    'options' => ['placeholder' => 'सबै','id' => 'bank','allowClear' => true,],
                                    'pluginOptions' => [
                                        'allowClear' => true
                                    ],
                                ]);
    ...
    <?= $form->field($model, 'year_search')->widget(Select2::classname(), [
                                    'data' => $year,
                                    'language' => 'en',
                                    'options' => ['placeholder' => 'सबै','id' => 'year'],
                                    'pluginOptions' => [
                                        'allowClear' => true
                                    ],
                                ]);
    ...
    <div class="col-sm-2">
    <?= Html::submitButton(Icon::show('search'). 'Search', ['name' => 'btn1','class'=>'btn btn-success','id'=>'find']) ?>
    </div>
    <div class="col-sm-3">
    <?= Html::a('<i class="glyphicon glyphicon-refresh"></i> Refresh', ['/site/province-report'], ['name'=>'btn2','id'=>'find1','class'=>'btn btn-primary']) ?>
    </div>
    <div class="col-sm-1">
    <?= Html::button(Icon::show('print'). 'Print',['name'=>'btn3','id'=>'find2','class'=>'btn btn-primary','onclick'=>'printDiv()']) ?>
    </div>
