...
$district_login=\yii\helpers\Arrayhelper::map(\app\models\District::find()->where(['id'=>$dis_id])->all(),'id','district_nepali');
$bank=\yii\helpers\Arrayhelper::map(\app\models\BankDetails::find()->where(['fk_district_id'=>$dis_id])->all(),'id','bank_name');
...
$this->params['breadcrumbs'][] = ['label' =>$district['district_nepali'],'url'=>['site/promunicipal','dis_id'=>$dis_id]];
...
<div class="col-md-12">
    ...
    <div class="col-sm-3">
    <?= Html::a('<i class="glyphicon glyphicon-refresh"></i> Refresh', ['/site/district-report','dis_id'=>$dis_id], ['name'=>'btn2','id'=>'find1','class'=>'btn btn-primary']) ?>
    </div>
    <div class="col-sm-1">
...
<script>
      function printDiv()
    {
        ...
        var divToPrint = document.getElementById('w5-container');
