...
<div class="col-sm-12">
        ...
        //     ->all();
            ...
            $total_chori=\app\models\ChoriBachat::find()->where(['fk_per_district'=>$user_details['fk_district_id']])->count();
            $verified_chhori=\app\models\ChoriBachat::find()->where(['fk_per_district'=>$user_details['fk_district_id']])->andWhere(['or',
            ['status'=>1],
            ['status'=>2],
            ['status'=>3],
            ['status'=>5],
            ...
            $unverified_chhori=\app\models\ChoriBachat::find()->where(['fk_per_district'=>$user_details['fk_district_id']])->andWhere(['or',
            ['status'=>0],
            ['status'=>4]
            ])->count();
            $total_chori=\app\models\ChoriBachat::find()->where(['fk_per_district'=>$user_details['fk_district_id']])->count();
            $running_chhori=\app\models\ChoriBachat::find()->where(['fk_per_district'=>$user_details['fk_district_id']])->andWhere(['status'=>5])->count();
            $withdraw_chhori=\app\models\ChoriBachat::find()->where(['fk_per_district'=>$user_details['fk_district_id']])->andWhere(['status'=>6])->count();
            $closed_chhori=\app\models\ChoriBachat::find()->where(['fk_per_district'=>$user_details['fk_district_id']])->andWhere(['status'=>7])->count();
            $total_initial=\app\models\PaymentChori::find()->where(['fk_district_id'=>$user_details['fk_district_id']])->where(['fk_economic_year'=>$year['economic_year']])->Sum('amount');
            $total_deposit=\app\models\OtherMonthPayment::find()->where(['fk_district_id'=>$user_details['fk_district_id']])->where(['fk_year'=>$year['economic_year']])->Sum('amount');
                //var_dump($total_initial);die;

            $total_chori=\app\models\ChoriBachat::find()->where(['fk_per_district'=>$user_details['fk_district_id']])->count();
            $total_initial=\app\models\PaymentChori::find()->where(['fk_district_id'=>$user_details['fk_district_id']])->andWhere(['fk_economic_year'=>$year['economic_year']])->Sum('amount');
            $total_deposit=\app\models\OtherMonthPayment::find()->where(['fk_district_id'=>$user_details['fk_district_id']])->andWhere(['fk_year'=>$year['economic_year']])->Sum('amount');
        ?>
