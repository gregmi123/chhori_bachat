...
<div class="row">
    ...
    <span style="font-weight:bold;">आर्थिक बर्ष:</span> <?php echo $nep_year?>
    </div> 
    ...
    <div class="col-md-6">
    <?= $form->field($model, 'fk_dismiss')->dropdownList($dismiss,['id' => 'dismiss', 'prompt' => 'छान्नुहोस्']) ?>
    </div>
    <div class="col-md-12">
    ...
    <div class="form-group">
        ...
        'data' => [
            'confirm' => 'के खारिज गर्न चाहानुहुन्छ ?',
            'method' => 'post',
        ],
    ]); ?>
    </div>
