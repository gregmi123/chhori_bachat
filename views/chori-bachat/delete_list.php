...
$this->params['breadcrumbs'][] = ['label'=>'Delete गर्ने छोरीहरुको सुची'];
...
<p>
        <?= Html::Button('Restore', ['class' => 'btn btn-success pull-right','style'=>'margin-left:1em;','id'=>'restore',
            'data-toggle'=>'modal',
    ...
    <p>
        <?= Html::Button('Delete', ['class' => 'btn btn-danger pull-right','id'=>'delete-permanent',
            'data-toggle'=>'modal',
            'data-target'=>'#exampleModal',
            'name'=>'btn',
        ]); ?> 
...
function myFunction(){
    ...
    if(keys.length >0){
                ...
                window.location = 'index.php?r=chori-bachat/reset-list&ids='+keys;
...
function deleteChhori(){
    ...
    if(keys.length >0){
                ...
                window.location = 'index.php?r=chori-bachat/delete-chhori&ids='+keys;
