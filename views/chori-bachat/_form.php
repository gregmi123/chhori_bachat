...
//     ,['id'=>'3','name'=>'संरक्षक']
// ];
// $sankrakchak_drop=ArrayHelper::map($sankrakchak,'id','name');
$sankrakchak=['1'=>'बुवा','2'=>'आमा','3'=>'अन्य'];

$message1=Yii::$app->session->getFlash('message');
$model->check_guardian=3;
?>
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <!-- <div class="col-md-4">
                                <img id="guardian" src="#" >
                                <= $form->field($model, 'guardian_image')->fileInput(['maxlength' => true, 'onchange' => 'guardianURL(this);','id'=>'guardian1']) ?>
                            </div> -->
                            <div class="row">
                        <div class="col-md-12"  id="photo-fileg">
                            <div class="col-md-6">
                                <img id="guardian" src="#" ><!-- comment -->
                                <?= $form->field($model, 'guardian_image')->fileInput(['maxlength' => true, 'onchange' => 'guardianURL(this);', 'id' => 'guardiang']) ?>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12"  id="photo-file">
                            <div class="col-md-6">
                                ...
                                <?= $form->field($model, 'image')->fileInput(['maxlength' => true, 'onchange' => 'readURL(this);', 'id' => 'computer-photo']) ?>
                            </div>
                            <div class="col-md-3" style="margin-top: 0px;margin-left: 15px;">
        ...
        <tr>
            <td>
                <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                        <?= $form->field($model,'mobile_no')->textInput(['type' => 'text', 'maxlength' => 10]); ?>
                    </div>
                    <div class="col-md-4">
            ...
            <td>
                <div class="col-md-12">
                    <div class="form-group">
                        <?= Html::submitButton('पेश गर्नुहोस', ['class' => 'btn btn-success','data' => ['disabled-text' => 'Please Wait']]) ?>
                    </div>
                </div>
            </td>
        </tr>
...
<script>
    function care(check_value){
            document.getElementById('take_care_detail').style.display = 'block';
        if(check_value==1){
...
<?php
$js = '$("#nepali-datepicker").nepaliDatePicker({ndpYear:true,ndpMonth:true,ndpYearCount:20});$("#nepali-datepicker1").nepaliDatePicker({ndpYear:true,ndpMonth:true,ndpYearCount:20});';
