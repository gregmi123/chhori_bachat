...
class NepaliCalender {
    ...
    public function eng_to_nep($yy, $mm, $dd) {
         ...
         $debug_info = "";
        if (NepaliCalender::is_range_eng($yy, $mm, $dd) == false) {
            return false;
        } else {
            ...
            for ($i = 0; $i < ($yy - $def_eyy); $i++) { //total days for month calculation...(english)
                if (NepaliCalender::is_leap_year($def_eyy + $i) == 1)
                    for ($j = 0; $j < 12; $j++)
            ...
            for ($i = 0; $i < ($mm - 1); $i++) {
                if (NepaliCalender::is_leap_year($yy) == 1)
            ...
            $nep_date["day"] = NepaliCalender::get_day_of_week($day);
            $nep_date["nmonth"] = NepaliCalender::get_nepali_month($m);
