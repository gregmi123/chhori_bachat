 ...
 */
class ChoriBachatDelete extends ChoriBachat
{
    /**
     * {@inheritdoc}
     */
    ...
    public function search($params)
    {
        ...
        $query = ChoriBachat::find()->where(['fk_user_id'=>$user_id])->andWhere(['fk_municipal_id'=>$user_details->fk_municipal_id])->andWhere(['payment_status'=>2])->OrderBy(['id'=>SORT_DESC]);
