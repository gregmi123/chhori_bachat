 ...
 */
class ChoriAccountDetailsSearch extends ChoriAccountDetails
{
    /**
     * {@inheritdoc}
     */
    ...
    //     $query = ChoriAccountDetails::find()->where(['fk_user_id'=>$user_id])->andWhere(['fk_municipal_id'=>$user_details->fk_municipal_id])
    //     ->andWhere(['or',
    //     ['bank_status'=>2],
    //     ['bank_status'=>3],
    //     ['bank_status'=>4],
